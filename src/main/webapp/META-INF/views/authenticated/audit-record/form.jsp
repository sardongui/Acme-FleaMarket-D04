...
<acme:form>
	<acme:form-moment code="authenticated.audit-record.form.label.creationMoment" path="creationMoment"/>
	...
	<acme:form-url code="authenticated.audit-record.form.label.status" path="status"/>
